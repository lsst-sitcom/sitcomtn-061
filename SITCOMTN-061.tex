...
For the minimal dataset, the observing epochs spread across multiple nights do not need to cover the same field, but should span a range of airmass, e.g., 1.0, 1.4, and 2.0, to demonstrate stable performance.
...
30 consecutive visits of the same field in the same band within a single epoch is desireable to achieve stable environmental conditions and isolate effects related to the instrumental calibration (e.g., illumination correction, camera distortion model).
